...
void DataFlashInit(void)
{
    ...
    if (((au32Config[0] & 0x01) == 1) || (au32Config[1] != (0x20000 - ((4)*(0x200)))) )
    {
        (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON |= (1ul << 4));
        au32Config[0] &= ~0x1;
        au32Config[1] = (0x20000 - ((4)*(0x200)));
...
void DataFlashWrite(uint32_t addr, uint32_t size, uint32_t buffer)
{
    ...
    else
    {
        do
        {
            ...
            if(offset || (size < (0x200)))
            {
                 

				DataFlashReadPage(alignAddr - (0x20000 - ((4)*(0x200))),   (uint32_t)&g_sectorBuf[0]);
            }
